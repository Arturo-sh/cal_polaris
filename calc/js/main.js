...
var primaDominical = false;

categoria = document.getElementById("combo_categoria");
salarioDiario = document.getElementById("salario_diario");
horasExtra = document.getElementById("horas_extra");
primaDominical = document.getElementById("prima_dominical");

categoria.addEventListener('change', () => {
  categoria = document.getElementById("combo_categoria");
  salarioDiario = document.getElementById("salario_diario");
  salarioDiario.value = categoria.value;
  calcularSalario();
});

salarioDiario.addEventListener('keyup', () => {
  calcularSalario();
});

horasExtra.addEventListener('keyup', () => {
  calcularSalario();
});

primaDominical.addEventListener('change', () => {
  calcularSalario();
});

function calcularSalario() {
  pagoPrimaDominical = 0;
  salarioStr = document.getElementById("salario_diario");
  primaDominical = document.getElementById("prima_dominical").checked;
  salarioDiario = parseFloat(salarioStr.value);
  horasExtra = parseFloat(document.getElementById("horas_extra").value);
  ...
  console.clear();
  document.getElementById("sueldo_ordinario").innerText = sueldoOrdinario.toFixed(2);
  document.getElementById("septimo_dia").innerText = septimoDia.toFixed(2);
  document.getElementById("pago_doble_extra").innerText = pagoDobleDescansoTrabajado.toFixed(2);
  console.log("pago_doble_extra: [TE]" + pagoDobleExtras.toFixed(2));
  document.getElementById("pago_triple_extra").innerText = pagoTripleDescansoTrabajado.toFixed(2);
  console.log("pago_triple_extra:[TE] " + pagoTripleExtras.toFixed(2));
  document.getElementById("pago_horas_extra").innerText = pagoDescansoTrabajado.toFixed(2);
  console.log("pago_total_extra [TE]: " + pagoTotalExtras.toFixed(2));
  document.getElementById("pago_prima_dominical").innerText = pagoPrimaDominical.toFixed(2);
  document.getElementById("pago_puntualidad").innerText = pagoPuntualidad.toFixed(2);
  document.getElementById("pago_asistencia").innerText = pagoAsistencia.toFixed(2);
  document.getElementById("vale_despensa").innerText = valeDespensa.toFixed(2);
  document.getElementById("bono_vale").innerText = bonoVale.toFixed(2);
  document.getElementById("total_vales_mensual").innerText = totalValesMensual.toFixed(2);
  document.getElementById("fondo_ahorro").innerText = fondoAhorro.toFixed(2);
  document.getElementById("pago_semanal_adi").innerText = sueldoSemanalADI.toFixed(2);
  document.getElementById("pago_isr").innerText = pagoISR.toFixed(2);
  document.getElementById("pago_cuota_sindical").innerText = pagoCuotaSindical.toFixed(2);
  document.getElementById("sueldo_neto_aproximado").innerText = sueldoNetoAproximado.toFixed(2);
}
